...
class BalanceResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'mints': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'tokens': ([BalanceToken],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, balance, mints, tokens, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, balance, mints, tokens, *args, **kwargs):  # noqa: E501
        """BalanceResponse - a model defined in OpenAPI
